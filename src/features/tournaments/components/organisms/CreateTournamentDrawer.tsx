...
interface CreateTournamentDrawerProps {
  open: boolean;
  onClose: () => void;
  onCreated?: () => void;
}

const CreateTournamentDrawer = ({ open, onClose, onCreated }: CreateTournamentDrawerProps) => (
  <Drawer
    anchor="right"
    open={open}
    onClose={onClose}
...
export default CreateTournamentDrawer;
